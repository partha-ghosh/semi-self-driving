...
from ssd.aim_confidence.model import AIM
from ssd.aim_confidence.config import GlobalConfig
from ssd.aim_confidence.data import scale_and_crop_image
...
class AIMAgent(autonomous_agent.AutonomousAgent):
	...
	def run_step(self, input_data, timestamp):
		...
		steer, throttle, brake, metadata = self.net.control_pid(pred_wp[:,:,:2], gt_velocity)
