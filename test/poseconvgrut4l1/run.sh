...
#SBATCH --output=/mnt/qb/work/geiger/pghosh58/transfuser/test/poseconvgrut4l1/%j.out  # File to which STDOUT will be written
#SBATCH --error=/mnt/qb/work/geiger/pghosh58/transfuser/test/poseconvgrut4l1/%j.err   # File to which STDERR will be written
#SBATCH --partition=gpu-2080ti        # gpu-2080ti-preemptable

scontrol show job $SLURM_JOB_ID 
cd /mnt/qb/work/geiger/pghosh58/transfuser/test/poseconvgrut4l1
